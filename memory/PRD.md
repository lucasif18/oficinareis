...
### 4. Minhas OS (Cliente Logado) ✅ IMPLEMENTADO
...
### 6. Serviços do Funcionário ✅ IMPLEMENTADO
...
- **Upload de fotos Antes/Depois** com botões dedicados e notificação para cliente e ADM
...
- **Funcionário:** funcionario@oficinareis.com / func123 (especialidades: Virabrequim, Bloco)
- **Cliente:** cliente@teste.com / cliente123 (OS #003 vinculada)
...
- [x] Página Minhas OS (MinhasOS.js) para cliente visualizar detalhes com timeline
- [x] Menu lateral correto para cada perfil
- [x] Upload de fotos pelo funcionário com botões Antes/Depois
- [x] Filtragem de serviços por setor do funcionário (especialidades)
